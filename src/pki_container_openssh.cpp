                                           ...
                                           ssh_key *pkey)
{
    ...
    case SSH_KEYTYPE_ED25519:
        ...
        key->ed25519_privkey = (ed25519_privkey*)malloc(ED25519_SK_LEN);
                                   ...
                                   void *auth_data)
{
    ...
    rc = bcrypt_pbkdf(passphrase,
                      strlen(passphrase),
                      (const u_int8_t*)ssh_string_data(salt),
                      ssh_string_len(salt),
                      key_material,
                      key_material_len,
                      rounds);
                                          ...
                                          void *auth_data)
{
    ...
    b64 = bin_to_base64((const unsigned char*)ssh_buffer_get_begin(buffer),
